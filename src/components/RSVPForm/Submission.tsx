...
export default function Submission(eventName: SubmissionProps, user: User) {
    return (
        <div  >
                ...
                <AlertDialogContent className='bg-[#F1EBDB] text-center rounded text-[#0060FF]'>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className={`text-center  text-pink-400 ${cinzel.className}`}>
                            <div className='text-center text-[#0060FF]'><p>{user.fullName}, We&apos;ve recieved your RSVP </p> <br />
