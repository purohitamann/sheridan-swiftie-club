...
const Body: React.FC = () => {
    return (
        <section className="flex flex-col justify-start items-center p-6 sm:p-10 w-full min-h-[100vh]">
            {/* Navigation Links */}
            ...
            <div
                ...
                className="flex flex-col justify-center items-center text-[#E4E2DD] text-base sm:text-lg rounded-md max-w-4xl text-center space-y-8"
            >
