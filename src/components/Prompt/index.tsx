    ...
    return (
        <div className="font-sans fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
            <div className="font-sans rounded-lg w-[80vw] max-w-lg p-6 relative">
                ...
                <p className="text-sm mb-4">
                    Again, we&apos;ll need your Evermore Order ID to enter the giveaway. By participating, you are supporting Ontarians in their fight against hunger and helping SSC continue more such initiatives.
                </p>
